...
feature correlation observed was $r = 0.441$, between Mean EAR and standard
deviation --- well short of anything problematic. All five features feed the
XGBoost ensemble independent diagnostic signal.
